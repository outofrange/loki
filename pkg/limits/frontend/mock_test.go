...
func (m *mockIngestLimitsClient) GetAssignedPartitions(_ context.Context, req *proto.GetAssignedPartitionsRequest, _ ...grpc.CallOption) (*proto.GetAssignedPartitionsResponse, error) {
